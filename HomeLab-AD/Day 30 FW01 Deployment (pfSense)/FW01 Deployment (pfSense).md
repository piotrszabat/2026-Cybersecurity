...
The next stage of the lab will focus on firewall policy implementation and network access control, including:

* Creating zone-based firewall rules
* Restricting communication between EXT, INT, and SOC networks
* Allowing controlled SOC monitoring traffic
* Testing network segmentation using ping, traceroute, and Nmap
* Validating firewall rule enforcement

---

If you want, I can also help you create a very strong GitHub README layout for the entire HomeLab (Days 1-30) that will make recruiters immediately understand your SOC lab project.
